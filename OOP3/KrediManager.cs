...
namespace OOP3
{
    ...
    interface IKrediManager //Tek başına bir anlam ifade etmez, sadece ebeveyn görevi gördüğü için interface dendi. Okunurluğu arttırmak için başına "I" konulur. Şablon demektir. Genelde operasyon sınıflarında kullanılır. Aynı zamanda referans tutucu görevi görür.
    {
        void Hesapla();
        void BiseyYap();
    }
